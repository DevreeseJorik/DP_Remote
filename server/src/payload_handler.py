...
class DumpPayloadHandler(PayloadHandler):
    def __init__(self, payload_length=292):
        ...
        self._setup_file_path = r"c:\Users\jorik\OneDrive\Documents\Projects\Pokemon\DP_Remote\payload_generator\out\bin\rom_hack.bin"
        self._has_sent_setup = True
        self._packet_index = 0

        self._dump_file = r"c:\Users\jorik\OneDrive\Documents\Projects\Pokemon\DP_Remote\memory_dump.bin"
    ...
    def get_payload(self):
        ...
        try:
            ...
            payload_logging.error(f"Payload file not found.")
            resp = b'\x01\x00\xa0\xe3\x10\x80\xbd\xe8'
            resp += b'\x00' * (self._payload_length - len(resp))
            return resp
